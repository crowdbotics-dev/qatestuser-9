"""
Django settings for qatestuser_9 project.
...
ROOT_URLCONF = 'qatestuser_9.urls'
...
WSGI_APPLICATION = 'qatestuser_9.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qatestuser_9 API",
    "DESCRIPTION": "API documentation for qatestuser_9 App",
    "VERSION": "v1",
}
